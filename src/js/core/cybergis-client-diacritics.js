CyberGIS.Diacritics =
{
	"removeDiacritics": function(str)
	{
		if(str!=undefined)
		{
			if(str.length>0)
			{
				for(var i = 0; i < CyberGIS.Diacritics.diacritics.adjusted.length; i++)
				{
					str = str.replace(CyberGIS.Diacritics.diacritics.adjusted[i].letters, CyberGIS.Diacritics.diacritics.adjusted[i].base);
				}
			}
		}
		return str;
	...
	diacritics:
	{
		...
		[
			...
			{'base':'n', 'letters':/[\u006E\u24DD\uFF4E\u01F9\u0144\u00F1\u1E45\u0148\u1E47\u0146\u1E4B\u1E49\u019E\u0272\u0149\uA791\uA7A5]/g},
			{'base':'nj','letters':/[\u01CC]/g},
			{'base':'o', 'letters':/[\u006F\u24DE\uFF4F\u00F2\u00F3\u00F4\u00F6\u1ED3\u1ED1\u1ED7\u1ED5\u00F5\u1E4D\u022D\u1E4F\u014D\u1E51\u1E53\u014F\u022F\u0231\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275]/g},
			{'base':'oe','letters': /[\u0153]/g},
			{'base':'oi','letters':/[\u01A3]/g},
			{'base':'ou','letters':/[\u0223]/g},
			{'base':'oo','letters':/[\uA74F]/g},
